...
Done with [GRPO](./grpo.py) as well, just one thing is remaining DPO.

Continuing paper reading in the time of training.

![alt text](./images/image%20copy%2013.png "Training")

updated this block, form reading the dpo paper again, and also some recommendations from [Perplexity](https://www.perplexity.ai/)
```python
class PRE:
    ...
    def calculate_perplexity(self, model, prompt, resp):
...
---
## Perplexity
SO i thought perplexity was just a metric something like corss entropy, bleu score. But now i realised whn going through youtube videos, perplexity is solving hallucinations!!

I know perplexity assess the confidence of the token generated by the model, but using it this way, is fucking awesome. When i saw through the task first, i thought only simple perplexity rewards.

but now i have chnaged the code fo rbaseline perpl, and model perpl, and understood the importance for this. Thank you lossfunk of reminding this.

---

---
### Perplexity Based Evaluation issues

1. training set preparation

![alt-text](./images/image%20copy%2014.png)
